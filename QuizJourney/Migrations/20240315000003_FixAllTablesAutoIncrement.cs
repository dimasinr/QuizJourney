...
{
    /// <inheritdoc />
    public partial class FixAllTablesAutoIncrement : Migration
    {
        /// <inheritdoc />
        ...
        {
            // This is a destructive migration, so we'll just recreate all tables as they were
            migrationBuilder.DropTable(name: "StudentAnswers");
            migrationBuilder.DropTable(name: "Choices");
            migrationBuilder.DropTable(name: "Questions");
            migrationBuilder.DropTable(name: "Rooms");
